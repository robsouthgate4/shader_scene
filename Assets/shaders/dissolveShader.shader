...
Shader "Unlit/Dissolve Shader"
{
    Properties {
        ...
        _DissolveFactor ("DissolveFactor", Range (0.0, 1.0)) = 0.0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 noise = tex2D(_Noise, i.uv * 0.1);
                ...
                // Now set a threshold for alpha channel
                float x = _DissolveFactor;
                float sinTime = abs(sin(_Time * 10.));
                ...
                float y = step(noise, abs(sinTime + 0.001));
                ...
                c.rgb += y * (fixed3(i.uv.x, i.uv.y, 1.0));
